...
public class PreferenceManager {
    ...
    private static String SOFT_KEYBOARD_HIGHT = "SOFT_KEYBOARD_HIGHT";
    ...
    public void setSoftKeybardHeight(int height){
        editor.putInt(SOFT_KEYBOARD_HIGHT, height);
        editor.commit();
    }

    public int getSoftKeybardHeight(){
        return mSharedPreferences.getInt(SOFT_KEYBOARD_HIGHT ,520);
    }
